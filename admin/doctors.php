        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="subtitle1" value="<?php echo "$subtitle1"; ?>" />
            </div>
            <!--5 service_title1 -->
            <div class="form-group">
                <label for="">Service Title 1</label>
                <input type="text" class="form-control" name="service_title1"
                    value="<?php echo "$service_title1"; ?>" />
            </div>
            <!--6 service_subtitle1 -->
            <div class="form-group">
                <label for="">Service Subtitle 1</label>
                <input type="text" class="form-control" name="service_subtitle1"
                    value="<?php echo "$service_subtitle1"; ?>" />
            </div>
            <!--7 service_title2 -->
            <div class="form-group">
                <label for="">Service Title 2</label>
                <input type="text" class="form-control" name="service_title2"
                    value="<?php echo "$service_title2"; ?>" />
            </div>
            <!--8 service_subtitle2 -->
            <div class="form-group">
                <label for="">Service Subtitle 2</label>
                <input type="text" class="form-control" name="service_subtitle2"
                    value="<?php echo "$service_subtitle2"; ?>" />
            </div>
            <!--9 service_title3 -->
            <div class="form-group">
                <label for="">Service Title 3</label>
                <input type="text" class="form-control" name="service_title3"
                    value="<?php echo "$service_title3"; ?>" />
            </div>
            <!--10 service_subtitle3 -->
            <div class="form-group">
                <label for="">Service Subtitle 3</label>
                <input type="text" class="form-control" name="service_subtitle3"
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="expt_name1" value="<?php echo "$expt_name1"; ?>" />
            </div>
            <!--21 expt_qul1 -->
            <div class="form-group">
                <label for="">Expert1 Qualification1</label>
                <input type="text" class="form-control" name="expt_qul1" value="<?php echo "$expt_qul1"; ?>" />
            </div>
            <!--22 expt_add1 -->
            <div class="form-group">
                <label for="">Expert1 Address1</label>
                <textarea class="form-control" name="expt_add1" rows="3"><?php echo "$expt_add1"; ?></textarea>
            </div>
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="expt_name2" value="<?php echo "$expt_name2"; ?>" />
            </div>
            <!--25 expt_qul2 -->
            <div class="form-group">
                <label for="">Expert2 Qualification2</label>
                <input type="text" class="form-control" name="expt_qul2" value="<?php echo "$expt_qul2"; ?>" />
            </div>
            <!--26 expt_add2 -->
            <div class="form-group">
                <label for="">Expert2 Address2</label>
                <textarea class="form-control" name="expt_add2" rows="3"><?php echo "$expt_add2"; ?></textarea>
            </div>
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="expt_name3" value="<?php echo "$expt_name3"; ?>" />
            </div>
            <!--29 expt_qul3 -->
            <div class="form-group">
                <label for="">Expert3 Qualification3</label>
                <input type="text" class="form-control" name="expt_qul3" value="<?php echo "$expt_qul3"; ?>" />
            </div>
            <!--30 expt_add3 -->
            <div class="form-group">
                <label for="">Expert3 Address3</label>
                <textarea class="form-control" name="expt_add3" rows="3"><?php echo "$expt_add3"; ?></textarea>
            </div>
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="expt_name4" value="<?php echo "$expt_name4"; ?>" />
            </div>
            <!--33 expt_qul4 -->
            <div class="form-group">
                <label for="">Expert4 Qualification4</label>
                <input type="text" class="form-control" name="expt_qul4" value="<?php echo "$expt_qul4"; ?>" />
            </div>
            <!--34 expt_add4 -->
            <div class="form-group">
                <label for="">Expert4 Address4</label>
                <textarea class="form-control" name="expt_add4" rows="3"><?php echo "$expt_add4"; ?></textarea>
            </div>
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="expt_name5" value="<?php echo "$expt_name5"; ?>" />
            </div>
            <!--37 expt_qul5 -->
            <div class="form-group">
                <label for="">Expert5 Qualification5</label>
                <input type="text" class="form-control" name="expt_qul5" value="<?php echo "$expt_qul5"; ?>" />
            </div>
            <!--38 expt_add5 -->
            <div class="form-group">
                <label for="">Expert5 Address5</label>
                <textarea class="form-control" name="expt_add5" rows="3"><?php echo "$expt_add5"; ?></textarea>
            </div>
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="expt_name6" value="<?php echo "$expt_name6"; ?>" />
            </div>
            <!--41 expt_qul6 -->
            <div class="form-group">
                <label for="">Expert6 Qualification6</label>
                <input type="text" class="form-control" name="expt_qul6" value="<?php echo "$expt_qul6"; ?>" />
            </div>
            <!--42 expt_add6 -->
            <div class="form-group">
                <label for="">Expert6 Address6</label>
                <textarea class="form-control" name="expt_add6" rows="3"><?php echo "$expt_add6"; ?></textarea>
            </div>
