      ...
      ?>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input name="subtitle1" type="text" class="form-control" value="<?php echo "$subtitle1"; ?>" />
            </div>

            <!-- title1 -->
            <div class="form-group">
                <label for="">Title1</label>
                <input name="title1" type="text" class="form-control" value="<?php echo "$title1"; ?>" />
            </div>
            ...
            <div class="form-group">
                ...
                <input name="tctitle" type="text" class="form-control" value="<?php echo "$tctitle"; ?>" />
            </div>
            ...
            <div class="form-group">
                ...
                <input name="tcsubtitle" type="text" class="form-control" value="<?php echo "$tcsubtitle"; ?>" />
            </div>
            <!-- tcimg  -->
            <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="lctitle" type="text" class="form-control" value="<?php echo "$lctitle"; ?>" />
            </div>
            <!-- lcsubtitle -->
            <div class="form-group">
                <label for="">Left Cart Subtitle</label>
                <input name="lcsubtitle" type="text" class="form-control" value="<?php echo "$lcsubtitle"; ?>" />
            </div>
            <!-- lcimg  -->
            <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="rctitle" type="text" class="form-control" value="<?php echo "$rctitle"; ?>" />
            </div>
            <!-- rcsubtitle -->
            <div class="form-group">
                <label for="">Right Cart Subtitle</label>
                <input name="rcsubtitle" type="text" class="form-control" value="<?php echo "$rcsubtitle"; ?>" />
            </div>
            <!-- rcimg  -->
            <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="bctitle" type="text" class="form-control" value="<?php echo "$bctitle"; ?>" />
            </div>
            <!-- bcsubtitle -->
            <div class="form-group">
                <label for="">Bottom Cart Subtitle</label>
                <input name="bcsubtitle" type="text" class="form-control" value="<?php echo "$bcsubtitle"; ?>" />
            </div>
            <!-- bcimg  -->
            <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="title2" type="text" class="form-control" value="<?php echo "$title2"; ?>" />
            </div>

            <!-- pnp1 -->
            <div class="form-group">
                <label for="">PNP1</label>
                <input name="pnp1" type="text" class="form-control" value="<?php echo "$pnp1"; ?>" />
            </div>
            <!-- pnp2 -->
            <div class="form-group">
                <label for="">PNP2</label>
                <input name="pnp2" type="text" class="form-control" value="<?php echo "$pnp2"; ?>" />
            </div>
            <!-- pnp3 -->
            <div class="form-group">
                <label for="">PNP3</label>
                <input name="pnp3" type="text" class="form-control" value="<?php echo "$pnp3"; ?>" />
            </div>
            <!-- pnp4 -->
            <div class="form-group">
                <label for="">PNP4</label>
                <input name="pnp4" type="text" class="form-control" value="<?php echo "$pnp4"; ?>" />
            </div>
            <!-- pnp5 -->
            <div class="form-group">
                <label for="">PNP5</label>
                <input name="pnp5" type="text" class="form-control" value="<?php echo "$pnp5"; ?>" />
            </div>
            <!-- pnp6 -->
            <div class="form-group">
                <label for="">PNP6</label>
                <input name="pnp6" type="text" class="form-control" value="<?php echo "$pnp6"; ?>" />
            </div>
            <!-- pnp7 -->
            <div class="form-group">
                <label for="">PNP7</label>
                <input name="pnp7" type="text" class="form-control" value="<?php echo "$pnp7"; ?>" />
            </div>

            <!-- dsc1 -->
            <div class="form-group">
                <label for="">PNPDSC1</label>
                <input name="dsc1" type="text" class="form-control" value="<?php echo "$dsc1"; ?>" />
            </div>
            <!-- dsc2 -->
            <div class="form-group">
                <label for="">PNPDSC2</label>
                <input name="dsc2" type="text" class="form-control" value="<?php echo "$dsc2"; ?>" />
            </div>
            <!-- dsc3 -->
            <div class="form-group">
                <label for="">PNPDSC3</label>
                <input name="dsc3" type="text" class="form-control" value="<?php echo "$dsc3"; ?>" />
            </div>
            <!-- dsc4 -->
            <div class="form-group">
                <label for="">PNPDSC4</label>
                <input name="dsc4" type="text" class="form-control" value="<?php echo "$dsc4"; ?>" />
            </div>
            <!-- dsc5 -->
            <div class="form-group">
                <label for="">PNPDSC5</label>
                <input name="dsc5" type="text" class="form-control" value="<?php echo "$dsc5"; ?>" />
            </div>
            <!-- dsc6 -->
            <div class="form-group">
                <label for="">PNPDSC6</label>
                <input name="dsc6" type="text" class="form-control" value="<?php echo "$dsc6"; ?>" />
            </div>
            <!-- dsc7 -->
            <div class="form-group">
                <label for="">PNPDSC7</label>
                <input name="dsc7" type="text" class="form-control" value="<?php echo "$dsc7"; ?>" />
            </div>

            <!-- title3 -->
            <div class="form-group">
                <label for="">Title3</label>
                <input name="title3" type="text" class="form-control" value="<?php echo "$title3"; ?>" />
            </div>

            <!-- subtitle2-->
            <div class="form-group">
                <label for="">Sub Title 2</label>
                <input name="subtitle2" type="text" class="form-control" value="<?php echo "$subtitle2"; ?>" />
            </div>
            ...
            <div class="form-group">
                ...
                <input name="whst1" type="text" class="form-control" value="<?php echo "$whst1"; ?>" />
            </div>
            <!-- whst2-->
            <div class="form-group">
                <label for="">Wash Hand Subtitle2</label>
                <input name="whst2" type="text" class="form-control" value="<?php echo "$whst2"; ?>" />
            </div>
            <!-- whst3-->
            <div class="form-group">
                <label for="">Wash Hand Subtitle3</label>
                <input name="whst3" type="text" class="form-control" value="<?php echo "$whst3"; ?>" />
            </div>
            <!-- whst4-->
            <div class="form-group">
                <label for="">Wash Hand Subtitle4</label>
                <input name="whst4" type="text" class="form-control" value="<?php echo "$whst4"; ?>" />
            </div>
            <!-- whst5-->
            <div class="form-group">
                <label for="">Wash Hand Subtitle5</label>
                <input name="whst5" type="text" class="form-control" value="<?php echo "$whst5"; ?>" />
            </div>
            <!-- whst6-->
            <div class="form-group">
                <label for="">Wash Hand Subtitle6</label>
                <input name="whst6" type="text" class="form-control" value="<?php echo "$whst6"; ?>" />
            </div>
