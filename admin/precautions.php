        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="pnt1_title1" value="<?php echo "$pnt1_title1"; ?>" />
            </div>
            <!--6 pnt1_desc1 -->
            <div class="form-group">
                <label for=""> Point1 Description1</label>
                <textarea class="form-control" name="pnt1_desc1" rows="3"><?php echo "$pnt1_desc1"; ?></textarea>
            </div>
            <!--7 pnt1_rimg1  -->
            <!-- <div class="form-group">
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="pnt2_title2" value="<?php echo "$pnt2_title2"; ?>" />
            </div>
            <!--9 pnt2_desc2 -->
            <div class="form-group">
                <label for=""> Point2 Description2</label>
                <textarea class="form-control" name="pnt2_desc2" rows="3"><?php echo "$pnt2_desc2"; ?></textarea>
            </div>
            <!--10 pnt2_rimg2  -->
            <!-- <div class="form-group">
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="pnt3_title3" value="<?php echo "$pnt3_title3"; ?>" />
            </div>
            <!--13 pnt3_desc3 -->
            <div class="form-group">
                <label for=""> Point3 Description3</label>
                <textarea class="form-control" name="pnt3_desc3" rows="3"><?php echo "$pnt3_desc3"; ?></textarea>
            </div>
            <!--14 title2 -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sd" value="<?php echo "$sd"; ?>" />
            </div>
            <!--16 snd -->
            <div class="form-group">
                <label for="">Should Not</label>
                <input type="text" class="form-control" name="snd" value="<?php echo "$snd"; ?>" />
            </div>

            <!--17 sd_pnt1_title1 -->
            <div class="form-group">
                <label for="">Should Point1 Title1</label>
                <input type="text" class="form-control" name="sd_pnt1_title1"
                    value="<?php echo "$sd_pnt1_title1"; ?>" />
            </div>
            <!--18 sd_pnt1_desc1 -->
            <div class="form-group">
                <label for="">Should Point1 Description</label>
                <textarea class="form-control" name="sd_pnt1_desc1" rows="3"><?php echo "$sd_pnt1_desc1"; ?></textarea>
            </div>
            <!--19 sd_pnt1_limg1  -->
            <!-- <div class="form-group">
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sd_pnt2_title2"
                    value="<?php echo "$sd_pnt2_title2"; ?>" />
            </div>
            <!--21 sd_pnt2_desc2 -->
            <div class="form-group">
                <label for="">Should Point2 Description2</label>
                <textarea class="form-control" name="sd_pnt2_desc2" rows="3"><?php echo "$sd_pnt2_desc2"; ?></textarea>
            </div>
            <!--22 sd_pnt2_rimg2  -->
            <!-- <div class="form-group">
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sd_pnt3_title3"
                    value="<?php echo "$sd_pnt3_title3"; ?>" />
            </div>
            <!--25 sd_pnt3_desc3 -->
            <div class="form-group">
                <label for="">Should Point3 Description3</label>
                <textarea class="form-control" name="sd_pnt3_desc3" rows="3"><?php echo "$sd_pnt3_desc3"; ?></textarea>
            </div>
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="snd_pnt1_title1"
                    value="<?php echo "$snd_pnt1_title1"; ?>" />
            </div>
            <!--28 snd_pnt1_desc1 -->
            <div class="form-group">
                <label for="">Should Not Point1 Description1</label>
                <textarea class="form-control" name="snd_pnt1_desc1"
                    rows="3"><?php echo "$snd_pnt1_desc1"; ?></textarea>
            </div>
            <!--29 snd_pnt2_title2 -->
            <div class="form-group">
                <label for="">Should Not Point2 Title2</label>
                <input type="text" class="form-control" name="snd_pnt2_title2"
                    value="<?php echo "$snd_pnt2_title2"; ?>" />
            </div>
            <!--30 snd_pnt2_desc2 -->
            <div class="form-group">
                <label for="">Should Not Point2 Description2</label>
                <textarea class="form-control" name="snd_pnt2_desc2"
                    rows="3"><?php echo "$snd_pnt2_desc2"; ?></textarea>
            </div>
            <!--31 snd_pnt3_rimg3  -->
            <!-- <div class="form-group">
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="snd_pnt3_title3"
                    value="<?php echo "$snd_pnt3_title3"; ?>" />
            </div>
            <!--34 snd_pnt3_desc3 -->
            <div class="form-group">
                <label for="">Should Not Point3 Description3</label>
                <textarea class="form-control" name="snd_pnt3_desc3"
                    rows="3"><?php echo "$snd_pnt3_desc3"; ?></textarea>
            </div>
            <!-- submit button -->
