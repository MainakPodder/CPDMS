      ...
      ?>
        <form action="home.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input name="sub_title" type="text" class="form-control" value="<?php echo "$sub_title"; ?>" />
            </div>
            <!-- image  -->
            <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="q1" type="text" class="form-control" value="<?php echo "$q1"; ?>" />
            </div>
            <!-- qna -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="q2" type="text" class="form-control" value="<?php echo "$q2"; ?>" />
            </div>
            <!-- qna2 -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="q3" type="text" class="form-control" value="<?php echo "$q3"; ?>" />
            </div>
            <!-- qn3 -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="link1" type="text" class="form-control" value="<?php echo "$link1"; ?>" />
            </div>
            <!-- img4_back -->
            <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="sub_text1" type="text" class="form-control" value="<?php echo "$sub_text1"; ?>" />
            </div>
            <!-- sub_txt2 -->
            <div class="form-group">
                <label for="">Sub Text2</label>
                <input name="sub_text2" type="text" class="form-control" value="<?php echo "$sub_text2"; ?>" />
            </div>
            <!-- sub_txt3 -->
            <div class="form-group">
                <label for="">Sub Text3</label>
                <input name="sub_text3" type="text" class="form-control" value="<?php echo "$sub_text3"; ?>" />
            </div>
            <!-- link2 -->
            <div class="form-group">
                <label for="">Link2</label>
                <input name="link2" type="text" class="form-control" value="<?php echo "$link2"; ?>" />
            </div>
            <!-- title3 -->
            <div class="form-group">
