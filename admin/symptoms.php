      ...
      ?>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="desc1" rows="3"><?php echo "$desc1"; ?></textarea>
            </div>
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sltitle1" value="<?php echo "$sltitle1"; ?>" />
            </div>
            <!-- slsubtitle1 -->
            <div class="form-group">
                <label for="">Slider Subtitle1</label>
                <input type="text" class="form-control" name="slsubtitle1" value="<?php echo "$slsubtitle1"; ?>" />
            </div>
            <!-- sldesc1 -->
            <div class="form-group">
                <label for="">Slider Description1</label>
                <textarea class="form-control" name="sldesc1" rows="3"><?php echo "$sldesc1"; ?></textarea>
            </div>
            <!-- slimg2 -->
            <!-- <div class="form-group">
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sltitle2" value="<?php echo "$sltitle2"; ?>" />
            </div>
            <!-- slsubtitle2 -->
            <div class="form-group">
                <label for="">Slider Subtitle2</label>
                <input type="text" class="form-control" name="slsubtitle2" value="<?php echo "$slsubtitle2"; ?>" />
            </div>
            <!-- sldesc2 -->
            <div class="form-group">
                <label for="">Slider Description2</label>
                <textarea class="form-control" name="sldesc2" rows="3"><?php echo "$sldesc2"; ?></textarea>
            </div>
            <!-- slimg3 -->
            <!-- <div class="form-group">
          ...
          <input type="file" class="form-control" name="image" />
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="sltitle3" value="<?php echo "$sltitle3"; ?>" />
            </div>
            <!-- slsubtitle3 -->
            <div class="form-group">
                <label for="">Slider Subtitle3</label>
                <input type="text" class="form-control" name="slsubtitle3" value="<?php echo "$slsubtitle3"; ?>" />
            </div>
            <!-- sldesc3 -->
            <div class="form-group">
                <label for="">Slider Description3</label>
                <textarea class="form-control" name="sldesc3" rows="3"><?php echo "$sldesc3"; ?></textarea>
            </div>
            <!-- title4 -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="q1" value="<?php echo "$q1"; ?>" />
            </div>
            <!-- qa1 -->
            <div class="form-group">
                <label for="">Answer1</label>
                <textarea class="form-control" name="qa1" rows="3"><?php echo "$qa1"; ?></textarea>
            </div>
            <!-- q2 -->
            <div class="form-group">
                <label for="">Question2</label>
                <input type="text" class="form-control" name="q2" value="<?php echo "$q2"; ?>" />
            </div>
            <!-- qa2 -->
            <div class="form-group">
                <label for="">Answer2</label>
                <textarea class="form-control" name="qa2" rows="3"><?php echo "$qa2"; ?></textarea>
            </div>
            <!-- q3 -->
            <div class="form-group">
                <label for="">Question3</label>
                <input type="text" class="form-control" name="q3" value="<?php echo "$q3"; ?>" />
            </div>
            <!-- qa3 -->
            <div class="form-group">
                <label for="">Answer3</label>
                <textarea class="form-control" name="qa3" rows="3"><?php echo "$qa3"; ?></textarea>
            </div>
